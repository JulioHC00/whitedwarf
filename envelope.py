...
def envelope_equations(x, variables):
  ...
  kappa = opacity((q+q_o)*rhor, T_r*(t+t_o))
...
ax[0,0].plot(del_envelope.radius, del_envelope.density, colour = 'orange')
...
ax[0,1].plot(del_envelope.radius, del_envelope.mass, colour = 'orange')
...
ax[1,0].plot(del_envelope.radius, del_envelope.temperature, colour = 'orange')
